...
// // autoTable(doc, {
// //   head: [['Order ID', 'Vendor', 'Delivery Date', 'Total Amount', 'Payment Status']],
// //   body: tableData,
// //   startY: 30,
// //   theme: 'grid',
// //   styles: {
...
// //           className="px-5 py-2 bg-black text-white rounded-md transition-colors"
// //         >
// //           View Details
// //         </button>
// //       ),
...
// //           className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
// //         >
// //           Export Excel
// //         </button>
// //         <button
// //           onClick={exportToPDF}
// //           className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white  bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
// //         >
// //           Export PDF
// //         </button>
// //       </div>
...
// //             <div>
// //               <h2 className="text-2xl font-semibold text-gray-900">Delivered Orders</h2>
...
//         <button
//           onClick={() => viewOrderDetails(row)}
//           className="px-3 py-1.5 bg-black text-white rounded-md transition-colors text-sm md:px-4 md:py-2 md:text-base"
//         >
//           View Details
//         </button>
//       ),
...
//         <button
//           onClick={exportToExcel}
//           className="inline-flex items-center px-3 py-1.5 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 md:px-4 md:py-2"
//         >
//           Export Excel
//         </button>
//         <button
//           onClick={exportToPDF}
//           className="inline-flex items-center px-3 py-1.5 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 md:px-4 md:py-2"
//         >
//           Export PDF
//         </button>
//       </div>
...
//           <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
//             <div>
//               <h2 className="text-xl sm:text-2xl font-semibold text-gray-900">Delivered Orders</h2>
//               <p className="mt-1 text-sm text-gray-500">
//                 Orders that have been successfully delivered
//               </p>
//             </div>
...
//               <button
//                 onClick={handleRefresh}
//                 className="inline-flex items-center px-3 py-1.5 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 md:px-4 md:py-2"
//                 disabled={loading}
//               >
//                 {loading ? (
//                   <>
...
//                   <button
//                     onClick={handlePrint}
//                     className="px-3 py-1.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 flex items-center gap-1.5 transition-colors text-sm"
//                   >
//                     <svg
//                       xmlns="http://www.w3.org/2000/svg"
//                       className="h-4 w-4"
...
//                   <button
//                     onClick={exportToPDF}
//                     className="px-3 py-1.5 bg-red-600 text-white rounded-lg hover:bg-red-700 flex items-center gap-1.5 transition-colors text-sm"
//                   >
//                     <svg
//                       xmlns="http://www.w3.org/2000/svg"
//                       className="h-4 w-4"
