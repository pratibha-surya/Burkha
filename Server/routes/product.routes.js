...
const { getAllProducts, getProductById, createProduct, updateProduct, deleteProduct, purchaseProduct ,getCoursesByCategory,getAllProductshome,getproducthome} = require('../controllers/product.controller');
